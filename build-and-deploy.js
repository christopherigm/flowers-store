...
// Editable variables
const name = 'flowers-store';
const jenkinsURL = 'https://jenkins.iguzman.com.mx';
const jenkinsURLProd = 'https://jenkins.flowers-store.com';
const apiURL = 'https://api.flowers-store.iguzman.com.mx/v1/';
const apiURLProd = 'https://api.flowers-store.com.mx/v1/';
